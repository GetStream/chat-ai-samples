# [Android Compose](https://getstream.io/tutorials/android-chat/) AI Sample App
...
If you want to learn more about building an AI assistant application using Jetpack Compose, check out [Build an AI Assistant for Android Using Compose](https://getstream.io/blog/android-assistant/).
